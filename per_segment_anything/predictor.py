...
class SamPredictor:
    ...
    def predict_torch(
        ...
        print("First values of point_coords:", point_coords[0, :3, :3])
        print("Shape of point_labels:", point_labels.shape)
        print("First values of point_labels:", point_labels[0, :3])
        ...
        print("First values of sparse_embeddings:", sparse_embeddings[0, :3, :3])
        ...
        print("First values of image_embeddings before mask decoder:", self.features[0, 0, :3, :3])
        ...
        print("First values of low res masks:", low_res_masks[0, 0, :3, :3])
